package com.bonc.register.test;
...
import com.bonc.register.controller.AppTestController;

@SpringBootTest
@TestInstance(value = Lifecycle.PER_CLASS)//每次测试构建新的测试实例，PRE_METHOD每个测试方法
public class TestRegisterApplication {
	private static final Logger LOG = LoggerFactory.getLogger(TestRegisterApplication.class);
	@Autowired
